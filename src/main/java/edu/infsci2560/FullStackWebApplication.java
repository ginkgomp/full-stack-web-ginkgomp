...
public class FullStackWebApplication {
    ...
    public static void main(String[] args) {
        ...
        UserRepository repositoryu = ctx.getBean(UserRepository.class);
        repositoryu.save(new User(1L,"user","Love pets!","https://az616578.vo.msecnd.net/files/responsive/cover/main/desktop/2016/02/15/6359109700410917201731765445_BEAGLE%20PUPPY.jpg")); 
    }
