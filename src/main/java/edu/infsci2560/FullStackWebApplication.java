...
public class FullStackWebApplication {
    ...
    public static void main(String[] args) {
        ...
        repositorye.save(new Event(2L,"Yuto's Birth","2015-03-16","Yuto's birthday is on March 16th. As a Golden Retriever, she is so cute and lovely."));        
        repositorye.save(new Event(2L,"New Home","2015-05-03","Yuki and Yuto come to our home! Yuki comes from a small Village in Indiana. She is the youngest among her sibings. Yuto comes from a small town of Indiana, she has bright eyes and there are heart-shaped hair on her chest."));
        repositorye.save(new Event(2L,"2 Months Old","2015-05-12","Yuki and Yuto adapt to the new environment only a few days after they moved in."));
        repositorye.save(new Event(2L,"Smiley Angel","2015-05-23","Yuki smiles like an angel."));
        ...
        repositorye.save(new Event(2L,"Two Years Old","2017-03-07","They turn to two while are as cute as the little puppies first brought into our family"));
