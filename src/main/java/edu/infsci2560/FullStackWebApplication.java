...
public class FullStackWebApplication {
    ...
    public static void main(String[] args) {
        ...
        repository.save(new Location(1L, "Huston Woods", LocationType.NaturalAttractions,"Oxford, OH","A good Natural Park that allow pets", "Hueston_Woods_Dog_Camping.jpg"));
        repository.save(new Location(2L, "Frick Park", LocationType.PublicPark,"Pittsburgh, PA", "A public park in Urban Pittsburgh, allow pets.","FrickPark.jpg"));
        repository.save(new Location(3L, "Hampton Inn", LocationType.Hotel,"Pittsburgh, PA","A hotel which is pet-friendly, try to spend a great time with your dogs here! ","hamptoninn.jpg"));
    }
